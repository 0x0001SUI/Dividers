...
/// A visual element that can be used to vertically separate content.
///
...
public struct VerticalDivider<S>: View where S: ShapeStyle {
    ...
    public var body: some View {
        Rectangle()
            .fill(style)
            .frame(width: accessibleLineWidth)
    }
